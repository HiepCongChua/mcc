...
(function (exports) {
    ...
    /*
        ...
        > let a = 42;
        > let a = BigInteger.toJSValue("0b101010"); // Not completely useless...
    */

    let CONSTRUCT = {}; // Unique token to call "private" version of constructor
    ...
    /*
        ...
        > let n0 = BigInteger();      // Same as <BigInteger.ZERO>
        > let n1 = BigInteger("123"); // Create a new <BigInteger> with value 123
        > let n2 = BigInteger(123);   // Create a new <BigInteger> with value 123
        > let n3 = BigInteger(n2);    // Return n2, unchanged
    ...
    */
    ...
    let BigInteger_base = 10000000;
    let BigInteger_base_log10 = 7;

    BigInteger.base = BigInteger_base;
    BigInteger.base_log10 = BigInteger_base_log10;

    let ZERO = new BigInteger([], 0, CONSTRUCT);
    // Constant: ZERO
    // <BigInteger> 0.
    BigInteger.ZERO = ZERO;

    let ONE = new BigInteger([1], 1, CONSTRUCT);
    // Constant: ONE
    // <BigInteger> 1.
    BigInteger.ONE = ONE;

    let M_ONE = new BigInteger(ONE._d, -1, CONSTRUCT);
    // Constant: M_ONE
    // <BigInteger> -1.
    ...
    */
    BigInteger.prototype.toString = function (base) {
        ...
        if (base === 10) {
            ...
            let numerals = BigInteger.digits;
    ...
    BigInteger.prototype.divRem = function (n) {
        ...
        while (b_index) {
            ...
            if (part._s === 0) {
                ...
                let highy = a._d[ylen - 1] * BigInteger_base + a._d[ylen - 2];
    ...
    */
    BigInteger.prototype.exp10 = function (n) {
        ...
        if (n > 0) {
            let k = new BigInteger(this._d.slice(), this._s, CONSTRUCT);
    ...
    */
    BigInteger.prototype.log = function () {
        ...
        let N = Math.ceil(30 / BigInteger_base_log10);
    ...
    */
    ...
    let MAX_EXP = BigInteger(0x7FFFFFFF);
    // Constant: MAX_EXP
