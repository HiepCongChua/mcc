...
let BLAKE2B_IV32 = new Uint32Array([
...
let SIGMA82 = new Uint8Array(SIGMA8.map(function (x) {
    return x * 2;
}));
...
let parameter_block = new Uint8Array([
...
Blake2b.prototype.digest = function (out) {
    let buf = (!out || out === 'binary' || out === 'hex') ? new Uint8Array(this.outlen) : out;
