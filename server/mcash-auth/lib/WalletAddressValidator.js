let XRPValidator = require('./wallet/RippleValidator');
let ETHValidator = require('./wallet/EthereumValidator');
let BTCValidator = require('./wallet/BitcoinValidator');
let XMRValidator = require('./wallet/MoneroValidator');
let NANOValidator = require('./wallet/NanoValidator');
let McashValidator = require('./wallet/McashValidator');
...
const WalletAddressValidator = {
    getByNameOrSymbol: function (currencyNameOrSymbol) {
        let nameOrSymbol = currencyNameOrSymbol.toLowerCase();
    ...
    validate: function (address, currencyNameOrSymbol, networkType = WalletAddressValidator.DEFAULT_NETWORK) {
        if (address && currencyNameOrSymbol) {
            let currency = this.getByNameOrSymbol(currencyNameOrSymbol);
...
WalletAddressValidator.PROD_NETWORK = 'prod';
WalletAddressValidator.TEST_NETWORK = 'testnet';
WalletAddressValidator.DEFAULT_NETWORK = 'prod';

module.exports = WalletAddressValidator;
